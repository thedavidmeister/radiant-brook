...
class BitstampDocumentationTest extends WebTestCase
{
    ...
    */
    public function testBody()
    {
        ...
        $this->assertEquals($this->expectedExtract(), $current);
    }
